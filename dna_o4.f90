...
program dnao4
  ...
  ! do Ecount=1,8
    ...
    open(unit=nini, file='dna_atgc_o4.ini')
    write(nini,*) E0
    do jj=1,ndof
      write(nini,*) 0._rk
    end do
    ...
    ! write(nini,*) 0._rk
    close(nini)
    open(unit=nfin, file='dna_atgc_o4.ini')
    read(nfin,*) E0
    do ii=1,ndof2
      read(nfin,*) x(ii)
    end do
    ...
    open(unit=nfoute, file='Dna_Order4_Eout.csv')
    open(unit=nfoutt, file='Dna_Order4_Tout.csv')
    open(unit=nfoutl, file='Dna_Order4_Lout.csv')
