program dnao4
  ...
  real(rk) :: h, tf, E0, ma, kb, lambda, pat, t1 ,t2
  ...
  !!!
  ! for getting the checked distribution
  ! call write_pdf_data(ndof, pat, 1100, '(I4)')
  !!!
  ...
  close(nfin)
  !-------------------------------------------------------------
  ! normalise momenta for initial energy
